...
% ---【Delete ...】按键的响应事件中调用,用于寻找与鼠标位置相邻最近的点。
...
[fn,pn] = uigetfile(seed, 'Load Map'); % 'Load Map'指对话框标题
if fn==0, return, end
...
if isempty(Obstacles)
    ...
    Obstacles(end+1) = Obstacle([], [velX; velY]); % end+1,指在当前基础上增加一行
end
